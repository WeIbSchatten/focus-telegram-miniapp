...
**Развёртывание на VPS Timeweb** — пошаговая инструкция в [docs/deploy-timeweb.md](deploy-timeweb.md): аренда сервера, установка Docker, настройка .env, запуск и доступ к странице Focus.
